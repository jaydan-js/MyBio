            ...
            <div data-name="hero-section" className="hero-gradient text-white min-h-screen flex items-center pt-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="text-center">
                        <h1 data-name="hero-title" className="text-4xl md:text-6xl font-bold mb-6">Creative Portfolio</h1>
                        <p data-name="hero-subtitle" className="text-xl md:text-2xl mb-8">Showcasing my projects and photography work</p>
